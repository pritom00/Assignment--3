-- FOOTBALL TICKET BOOKING SYSTEM - FINAL SUBMISSION
-- Description: Complete DDL + Data + Queries
-- =========================================================================
...
-- Query 2: Users name search (Tanvir or Haque)
SELECT
    user_id,
    full_name,
    email
...
-- Query 3: NULL Payment Status with COALESCE
SELECT
    booking_id,
    user_id,
    match_id,
...
-- Query 4: INNER JOIN - Booking with User and Match details
SELECT
    b.booking_id,
    u.full_name,
    m.fixture,
...
-- Query 5: LEFT JOIN - All Users with their Bookings
SELECT
    u.user_id,
    u.full_name,
    b.booking_id
...
-- Query 7: Top 2 expensive matches skipping the highest (OFFSET)
SELECT
    match_id,
    fixture,
    base_ticket_price
